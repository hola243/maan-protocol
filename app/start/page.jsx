...
export default function AuthPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.location.hash === '#login') setMode('login');
  ...
  return (
    <>
      <header>
        <div className="kicker"><a href="/landing.html" style={{ color: 'var(--accent-soft)', textDecoration: 'none' }}>&larr; Protocol by MAAN.life</a></div>
