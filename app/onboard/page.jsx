...
export default function OnboardPage() {
  ...
  const [f, setF] = useState({ age: '', ft: '', in: '', weight: '', sex: null, objective: null, days: 6, sport: 2, equipment: null, experience: null, injuries: '' });
    ...
    <>
      ...
      <div className="card">
        ...
        <div className="grid2">
          ...
          <div>
            <label>Martial arts / sport sessions per week</label>
